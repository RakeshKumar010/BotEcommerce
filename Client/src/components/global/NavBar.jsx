    ...
    <div>
      <nav className="relative px-10 py-4 flex justify-between items-center bg-white">
        ...
        <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2  lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
          <li>
            <Link
              className="text-sm text-gray-900 font-bold hover:text-gray-500"
              to="#"
            >
              HOME
            </Link>
          ...
          <li>
            <Link className="text-sm text-gray-900 font-bold " to="#">
              NEW ARRIVALS
            </Link>
          </li>
          <li className="text-gray-300">
        ...
        <FaCartPlus className='text-2xl hidden md:block ' />
